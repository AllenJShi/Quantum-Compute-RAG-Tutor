...
class RunConfig:
    ...
    team_email: str = "allenjunsheng@gmail.com"
...
if __name__ == "__main__":
    ...
    # print("\n--- Running export_reports_to_markdown ---")
